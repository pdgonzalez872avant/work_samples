...
previous version and should leave it empty. 
DANGER: This test will delete any existing message table
"""
...
class testRealEmail_traffic(unittest.TestCase):
    def setUp(self):
        """
        Reads an arbitrary number of mail messages 
        and stores them in a brand new table.
    ...
    def test_not_empty(self):
        ...
        the loop bodies in the other tests will never run, and potential errors
    ...
    def test_dates(self):
        """
        Verify that retrieving records between the minimum and mazimum dates
        return an appropriate number of records.
        """
