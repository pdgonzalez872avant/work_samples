...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        method and subject double clicks to display_method
        """
        ...
        l3 = Label(self, text="Sender's Email Contains:")
    ...
    def display_mail(self, event):
        """
        Display the message corresponding to the subject line that the user just clicked on.
        """
